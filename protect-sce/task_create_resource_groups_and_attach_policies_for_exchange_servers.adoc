...
.. En la sección Configure schedules for selected policies, haga clic en *image:../media/add_policy_from_resourcegroup.gif["añada una política desde el grupo de recursos"]* en la columna *Configure Schedules* de la política para la que desea configurar la programación.
