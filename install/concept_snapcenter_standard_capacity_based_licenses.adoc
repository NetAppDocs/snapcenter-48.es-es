...
. En la sección Licencia de la página Software, seleccione *Agregar* (image:../media/add_policy_from_resourcegroup.gif["añada una política desde el grupo de recursos"]).
