...
. Seleccione los clones y, a continuación, haga clic image:../media/delete_icon.gif["icono de eliminar"] en para eliminar clones o en image:../media/split_cone.gif["dividir clon"] para dividir los clones.
