...
+
.. Haga clic en *Configurar directorio de registro* y, en la página Configurar directorio de registro de host, haga clic en *examinar* y complete los siguientes pasos:
+
