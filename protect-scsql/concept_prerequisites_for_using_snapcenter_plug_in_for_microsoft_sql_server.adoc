...
+
Para obtener información sobre cómo ejecutar el cmdlet, consulte https://docs.netapp.com/us-en/snapcenter-cmdlets-48/index.html["Guía de referencia de cmdlets de SnapCenter Software"]
