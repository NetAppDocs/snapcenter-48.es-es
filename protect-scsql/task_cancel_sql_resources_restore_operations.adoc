...
Panel de actividades
 a| 
. Después de iniciar la operación de restauración, haga clic en image:../media/activity_pane_icon.gif["icono de actividad"] en el panel Activity para ver las cinco operaciones más recientes.
